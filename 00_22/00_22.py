...
img = img_as_float(io.imread(r"..\images\denoising\noisy_img.jpg"))
...
plt.imsave(r"..\images\gaussian.jpg", gaussian_img)
...
plt.imsave(r"..\images\median.jpg", median_img)
...
plt.imsave(r"images/NLM.jpg",denoise_img)
