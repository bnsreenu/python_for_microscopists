...
the index_using_resnet_pretrained.py file. 

Next, an image gets loaded and features extracted using the same ResNet50 network
...
performed using the cosine distance method. 
